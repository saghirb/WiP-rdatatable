\documentclass[a4paper,9pt,twocolumn,twoside,printwatermark=true]{pinp}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WP[Country }\OperatorTok{%in%}\StringTok{ "Portugal"}\NormalTok{]}
\CommentTok{#       Country Code Year pctWiP Ratio}
...
\NormalTok{WP[Country }\OperatorTok{%in%}\StringTok{ "Portugal"}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{WP[Country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Portugal"}\NormalTok{, }\StringTok{"Sweden"}\NormalTok{, }\StringTok{"Spain"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cWP[Year }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1990}\NormalTok{, }\DecValTok{2018}\NormalTok{) }\OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(Continent)][}
...
\StringTok{                   }\NormalTok{pctDiff }\OperatorTok{<=}\StringTok{ }\OperatorTok{-}\DecValTok{5}\NormalTok{]}\OperatorTok{$}\NormalTok{Country)}

\NormalTok{WP[Country }\OperatorTok{%in%}\StringTok{ }\NormalTok{dclpct] }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(Year, pctWiP, }\DataTypeTok{colour=}\NormalTok{Country)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1990}\NormalTok{, }\DecValTok{2020}\NormalTok{, }\DecValTok{5}\NormalTok{)) }\OperatorTok{+}
...
\NormalTok{    .(Country, Year, pctWiP, RankG, TotalG)][}
      \KeywordTok{order}\NormalTok{(Year)]}
\CommentTok{#       Country Year pctWiP RankG TotalG}
\CommentTok{#   1: Portugal 1990    7.6  66.0    138}
\CommentTok{#   2: Portugal 1997   13.0  41.5    161}
\CommentTok{#   3: Portugal 1998   13.0  49.5    163}
\CommentTok{#   4: Portugal 1999   18.7  24.0    154}
\CommentTok{#   5: Portugal 2000   17.4  34.0    158}
\CommentTok{#   6: Portugal 2001   18.7  33.0    168}
\CommentTok{#   7: Portugal 2002   19.1  41.0    161}
\CommentTok{#   8: Portugal 2003   19.1  46.0    175}
\CommentTok{#   9: Portugal 2004   19.1  54.0    182}
\CommentTok{#  10: Portugal 2005   21.3  45.5    185}
\CommentTok{#  11: Portugal 2006   21.3  49.5    189}
\CommentTok{#  12: Portugal 2007   28.3  28.0    188}
\CommentTok{#  13: Portugal 2008   28.3  28.0    187}
\CommentTok{#  14: Portugal 2009   27.4  33.0    187}
\CommentTok{#  15: Portugal 2010   27.4  34.0    187}
\CommentTok{#  16: Portugal 2011   28.7  31.0    188}
\CommentTok{#  17: Portugal 2012   28.7  35.0    188}
\CommentTok{#  18: Portugal 2013   28.7  39.0    186}
\CommentTok{#  19: Portugal 2014   31.3  35.0    187}
\CommentTok{#  20: Portugal 2015   34.8  29.0    188}
\CommentTok{#  21: Portugal 2016   34.8  27.0    191}
\CommentTok{#  22: Portugal 2017   34.8  28.0    192}
\CommentTok{#  23: Portugal 2018   34.8  29.0    192}
\CommentTok{#       Country Year pctWiP RankG TotalG}
\end{Highlighting}
\end{Shaded}
...
countries in the world, with the fluctuations of its ranking subject to
random variation.
...
\begin{Highlighting}[]
\NormalTok{cWP[Country}\OperatorTok{==}\StringTok{"Portugal"}\NormalTok{, }
\NormalTok{    .(Country, Year, pctWiP, RankC, TotalC)][}
      \KeywordTok{order}\NormalTok{(Year)]}
\CommentTok{#       Country Year pctWiP RankC TotalC}
\CommentTok{#   1: Portugal 1990    7.6  22.0     28}
\CommentTok{#   2: Portugal 1997   13.0  16.5     39}
\CommentTok{#   3: Portugal 1998   13.0  18.5     37}
\CommentTok{#   4: Portugal 1999   18.7  12.0     38}
\CommentTok{#   5: Portugal 2000   17.4  16.0     38}
\CommentTok{#   6: Portugal 2001   18.7  15.0     41}
\CommentTok{#   7: Portugal 2002   19.1  15.0     39}
\CommentTok{#   8: Portugal 2003   19.1  17.0     41}
\CommentTok{#   9: Portugal 2004   19.1  21.0     42}
\CommentTok{#  10: Portugal 2005   21.3  20.0     42}
\CommentTok{#  11: Portugal 2006   21.3  21.0     44}
\CommentTok{#  12: Portugal 2007   28.3  15.0     44}
\CommentTok{#  13: Portugal 2008   28.3  13.0     44}
\CommentTok{#  14: Portugal 2009   27.4  15.0     44}
\CommentTok{#  15: Portugal 2010   27.4  15.0     44}
\CommentTok{#  16: Portugal 2011   28.7  14.0     44}
\CommentTok{#  17: Portugal 2012   28.7  15.0     43}
\CommentTok{#  18: Portugal 2013   28.7  17.0     43}
\CommentTok{#  19: Portugal 2014   31.3  16.0     43}
\CommentTok{#  20: Portugal 2015   34.8  12.0     43}
\CommentTok{#  21: Portugal 2016   34.8  11.0     43}
\CommentTok{#  22: Portugal 2017   34.8  12.0     43}
\CommentTok{#  23: Portugal 2018   34.8  12.0     43}
\CommentTok{#       Country Year pctWiP RankC TotalC}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cWP[Country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Portugal"}\NormalTok{, }\StringTok{"Sweden"}\NormalTok{, }\StringTok{"Spain"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cWP[Year }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1990}\NormalTok{, }\DecValTok{2018}\NormalTok{) }\OperatorTok{&}\StringTok{ }\NormalTok{RankC}\OperatorTok{==}\DecValTok{1}\NormalTok{][}
    \KeywordTok{order}\NormalTok{(Continent, Year), }
